...
$_GATEWAYLANG['autopix_tagline'] = 'Configure o pagamento automático das suas faturas via PIX';
...
$_GATEWAYLANG['autopix_table_status'] = 'Status PIX Automático';
$_GATEWAYLANG['autopix_table_actions'] = 'Ações';
...
$_GATEWAYLANG['btn_consent_active'] = 'Consentimento Ativo';
$_GATEWAYLANG['btn_awaiting_acceptance'] = 'Aguardando Aceite';
$_GATEWAYLANG['btn_sending'] = 'Gerando...';
...
$_GATEWAYLANG['btn_pending_invoice_tooltip'] = 'Para gerar o QR Code, todas as faturas em aberto deste produto devem ser pagas';
$_GATEWAYLANG['btn_inactive_product_tooltip'] = 'Este produto está :status, para gerar o QR Code este produto deve estar ativo';

// AutoPix - Filtros
$_GATEWAYLANG['filter_by_status'] = 'Filtrar por status';
$_GATEWAYLANG['filter_all_services'] = 'Todos os serviços';
$_GATEWAYLANG['btn_clear_filters'] = 'Limpar filtros';

// AutoPix - Mensagens
$_GATEWAYLANG['no_services_found'] = 'Nenhum serviço ativo encontrado';
$_GATEWAYLANG['no_services_message'] = 'Você não possui serviços ativos para configurar o PIX Automático.';
...
$_GATEWAYLANG['autopix_description'] = 'O <strong>PIX Automático</strong> permite que suas faturas sejam pagas automaticamente no vencimento, diretamente da sua conta bancária, sem necessidade de gerar um novo código PIX a cada mês.';
$_GATEWAYLANG['autopix_notification_title'] = 'Como Ativar (Jornada 2):';
$_GATEWAYLANG['autopix_notification_description'] = 'Ao clicar em <strong>Gerar QR Code</strong>, será exibido um QR Code na tela. Abra o aplicativo do seu banco, escaneie o QR Code com a câmera e aceite o consentimento. Após a confirmação, suas faturas serão pagas automaticamente no vencimento.';
$_GATEWAYLANG['autopix_feature_automatic'] = '<strong>Pagamento automático:</strong> Suas faturas são pagas automaticamente no vencimento';
$_GATEWAYLANG['autopix_feature_secure'] = '<strong>Seguro:</strong> Transações autorizadas e processadas pelo Banco do Brasil';
$_GATEWAYLANG['autopix_feature_control'] = '<strong>Controle total:</strong> Você pode revogar o consentimento a qualquer momento';

// AutoPix - Controle de Acesso
...
$_GATEWAYLANG['access_denied_verification'] = 'Não foi possível verificar suas informações. Por favor, tente novamente.';
